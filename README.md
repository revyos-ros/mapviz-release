...
The packages in the `mapviz` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy mapviz --override-release-repository-push-url git@github.com:revyos-ros/mapviz-release.git --edit` on `Wed, 18 Jun 2025 06:11:41 -0000`
...
The packages in the `mapviz` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble mapviz --override-release-repository-push-url git@github.com:revyos-ros/mapviz-release.git` on `Mon, 16 Jun 2025 05:05:55 -0000`
...
## mapviz (jazzy) - 2.4.5-2

The packages in the `mapviz` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy mapviz --override-release-repository-push-url git@github.com:revyos-ros/mapviz-release.git` on `Thu, 12 Jun 2025 05:55:56 -0000`
...
The packages in the `mapviz` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy mapviz --override-release-repository-push-url git@github.com:revyos-ros/mapviz-release.git --edit` on `Wed, 05 Mar 2025 05:31:51 -0000`
...
The packages in the `mapviz` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble mapviz --override-release-repository-push-url git@github.com:revyos-ros/mapviz-release.git` on `Sat, 14 Dec 2024 08:18:18 -0000`
...
The packages in the `mapviz` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy mapviz --override-release-repository-push-url git@github.com:revyos-ros/mapviz-release.git` on `Fri, 27 Sep 2024 05:39:03 -0000`
...
The packages in the `mapviz` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble mapviz --override-release-repository-push-url git@github.com:revyos-ros/mapviz-release.git` on `Fri, 20 Sep 2024 05:25:02 -0000`
...
## mapviz (jazzy) - 2.3.0-5

The packages in the `mapviz` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy mapviz --override-release-repository-push-url git@github.com:revyos-ros/mapviz-release` on `Thu, 27 Jun 2024 12:31:08 -0000`
...
## mapviz (jazzy) - 2.3.0-4

The packages in the `mapviz` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy mapviz --override-release-repository-push-url git@github.com:revyos-ros/mapviz-release` on `Thu, 20 Jun 2024 09:25:00 -0000`
